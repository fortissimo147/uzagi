...
const p=await br.newPage({viewport:{width:1520,height:660}});
const errs=[]; p.on("pageerror",e=>errs.push(e.message));
await p.goto("http://127.0.0.1:5191/tools/preview/sheet.html");
await p.waitForFunction(()=>window.__done,null,{timeout:20000});
await p.locator("#out").screenshot({path:"/tmp/claude-0/-home-user-uzagi/5aa2bc9c-0c15-5810-a1ac-78851a641026/scratchpad/heroine-sheet.png"});
